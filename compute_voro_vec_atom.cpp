...
/* ----------------------------------------------------------------------
   Contributing author: Daniel Schwen, Bin Xu
------------------------------------------------------------------------- */
...
#include <string.h>
#include <stdlib.h>
#include "compute_voro_vec_atom.h"
#include "atom.h"
#include "group.h"
#include "update.h"
#include "modify.h"
...
ComputeVoroVec::ComputeVoroVec(LAMMPS *lmp, int narg, char **arg) :
...
void ComputeVoroVec::compute_peratom()
{
...
void ComputeVoroVec::buildCells()
{
  int i;
  const double e = 0.01;
...
void ComputeVoroVec::checkOccupation()
{
...
------------------------------------------------------------------------- */
void ComputeVoroVec::processCell(voronoicell_neighbor &c, int i)
{
...
void ComputeVoroVec::compute_vector()
{
...
void ComputeVoroVec::compute_local()
{
...
int ComputeVoroVec::pack_forward_comm(int n, int *list, double *buf,
...
void ComputeVoroVec::unpack_forward_comm(int n, int first, double *buf)
{
  int i,last,m=0;
  last = first + n;
