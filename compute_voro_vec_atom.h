...
ComputeStyle(voro_vec/atom,ComputeVoroVec)

#else

#ifndef LMP_COMPUTE_VORO_VEC_H
#define LMP_COMPUTE_VORO_VEC_H
...
class ComputeVoroVec : public Compute {
 public:
  ComputeVoroVec(class LAMMPS *, int, char **);
  ~ComputeVoroVec();
  void init();
